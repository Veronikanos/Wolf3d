...
/*   Updated: 2019/07/26 21:10:22 by vtlostiu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void				init_tex(t_pix *pix)
{
	...
	pix->tex_arr[5] = load_tex(pix, "textures/concrete.jpeg");
	pix->tex_arr[6] = load_tex(pix, "textures/red_bricks.gif");
	pix->tex_arr[7] = load_tex(pix, "textures/stones.jpg");
}
